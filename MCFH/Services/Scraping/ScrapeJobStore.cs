...
public class ScrapeJobStore
{
    ...
    public ScrapeJobState Create(string jobId, int projectId, int userId)
    {
        CleanupExpired();
        var state = new ScrapeJobState(jobId, projectId, userId);
        _jobs[jobId] = state;
        return state;
    }
...
public class ScrapeJobState
{
    ...
    public ScrapeJobState(string jobId, int projectId, int userId)
    {
        JobId = jobId;
        ProjectId = projectId;
        UserId = userId;
